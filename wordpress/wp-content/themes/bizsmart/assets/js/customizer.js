...
wp.customize.controlConstructor['bizsmart-section-order'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';

    var control = this;
    jQuery('#customize-control-' + control.params.id).find('.bizsmart-sortable-section').sortable({
