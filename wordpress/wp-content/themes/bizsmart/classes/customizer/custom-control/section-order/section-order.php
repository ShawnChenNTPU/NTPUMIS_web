...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class BizSmart_Section_Order extends WP_Customize_Control {
		 ...
		 * @package BizSmart Theme
		 */
		public $type = 'bizsmart-section-order';
		...
		protected function content_template() {
			?>
			<div class="bizsmart-section-order">
				<span class="customize-control-title">{{{ data.label }}}</span>
				<span class="description customize-control-description">{{{ data.description }}}</span>
				<# if( '' != data.sections ){ #>
				<ul class="bizsmart-sortable-section {{data.id}}">
				...
				<# }else{ #>
					<li><?php esc_html_e( 'No section enabled. Please enable sections', 'bizsmart' ); ?></li>
				<# } #>
...
BizSmart_Customizer::add_custom_control( array(
    ...
    'class'    => 'BizSmart_Section_Order',
    'sanitize' =>  array( 'BizSmart_Section_Order', 'sanitize' )
));