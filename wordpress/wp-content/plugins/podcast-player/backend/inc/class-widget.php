				...
				'info'    => array(
					...
					'items' => array(
						...
						'main_menu_items'   => array(
							...
							'hide_callback' => function() use ( $widget, $settings ) {
								return ! $settings['podcast_menu'];
							},
						),
						'pp_apple_sub'      => array(
							'setting'       => 'pp_apple_sub',
							'label'         => esc_html__( 'Apple Podcast Subscription link  (Depricated, Use Subscription Menu Above).', 'podcast-player' ),
							'type'          => 'url',
							'hide_callback' => function() use ( $widget, $settings ) {
						...
						'pp_google_sub'     => array(
							...
							'label'         => esc_html__( 'Google Podcast Subscription link  (Depricated, Use Subscription Menu Above).', 'podcast-player' ),
							'type'          => 'url',
							'hide_callback' => function() use ( $widget, $settings ) {
								return $settings['podcast_menu'] && $settings['main_menu_items'];
							},
						...
						'pp_spotify_sub'    => array(
							...
							'label'         => esc_html__( 'Spotify Podcast Subscription link  (Depricated, Use Subscription Menu Above).', 'podcast-player' ),
							'type'          => 'url',
							'hide_callback' => function() use ( $widget, $settings ) {
								return $settings['podcast_menu'] && $settings['main_menu_items'];
							},
