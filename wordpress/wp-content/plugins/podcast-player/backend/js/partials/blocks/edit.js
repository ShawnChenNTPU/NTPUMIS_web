					...
					}
					{
						<PanelBody initialOpen={ false } title={ __( 'Change Podcast Content', 'podcast-player' ) }>
							...
							}
							{
								...
								<TextControl
									label={ __( 'Apple Podcast Subscription link (Depricated, Use Subscription Menu Above)', 'podcast-player' ) }
									value={ appleSub }
							...
							}
							{
								( ! podcastMenu || ! mainMenuItems ) &&
								<TextControl
									label={ __( 'Google Podcast Subscription link  (Depricated, Use Subscription Menu Above)', 'podcast-player' ) }
									value={ googleSub }
							...
							}
							{
								( ! podcastMenu || ! mainMenuItems ) &&
								<TextControl
									label={ __( 'Spotify Podcast Subscription link  (Depricated, Use Subscription Menu Above)', 'podcast-player' ) }
									value={ spotifySub }
