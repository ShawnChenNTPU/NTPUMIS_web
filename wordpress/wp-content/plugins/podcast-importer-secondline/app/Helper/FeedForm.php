...
class FeedForm {
  ...
  public static function field_definitions() :array {
    ...
    foreach( postcast_importer_secondline_supported_post_types() as $post_type )
    ...
    $response[ 'post_type' ] = [
      ...
      'default'     => postcast_importer_secondline_default_post_type(),
      'storage'     => [
        'type'  => 'meta',
    ...
    $response[ 'post_taxonomies' ] = [
      ...
      'options'     => postcast_importer_secondline_get_taxonomies_select_definition( array_keys( $post_type_options ), true ),
      'storage'     => [
        'type'  => 'meta',
    ...
    if( postcast_importer_secondline_has_parent_show_support() ) {
      ...
      $response[ 'secondline_parent_show' ] = [
        ...
        ] + postcast_importer_secondline_post_type_id_title_assoc( 'secondline_shows' ),
        'storage'     => [
          'type'  => 'meta',
    ...
    if( !postcast_importer_secondline_feed_limit_reached() ) {
